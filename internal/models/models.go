...
type Message struct {
	...
	ReceiverID uuid.UUID `json:"receiverId"` // ID of the user who is the intended recipient.
...
type File struct {
	ID               uuid.UUID `json:"id"`               // Unique identifier for the file.
	SenderID         uuid.UUID `json:"senderId"`         // ID of the user who sent the file.
	ReceiverID       uuid.UUID `json:"receiverId"`       // ID of the user who is the intended recipient.
...
type Metric struct {
	ID        uuid.UUID `json:"id"`        // Unique identifier for the metric entry.
